...
if(isset($_POST['save'])){
	...
	if(file_exists($fileName)){
		$arr=file($fileName) or die('ERROR: cannot file file');
...
<form method="post">
  <div class="form-group">
    ...
    <input type="text" name="file" class="form-control" id="exampleFormControlInput1" placeholder="Filename">
  </div>
  ...
  <div class="form-group">
    <label for="fread">Enter file name</label>
    <input type="text" name="file" class="form-control" id="fread1" placeholder="Filename">
  </div>
  
  <div class="form-group">
    <label for="extread">choose extension</label>
    <select class="form-control" name="exten" id="extread">
	  <option value="">choose extension</option>
      <option>.txt</option>
      <option>.doc</option>
      <option>.pdf</option>
